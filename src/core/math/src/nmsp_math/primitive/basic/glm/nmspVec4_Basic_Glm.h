...
public:
	...
	bool	equals	(const Vec4& rhs, T epsilon = Math::epsilon<T>()) const;
	bool	equals0	(const Vec4& rhs, T epsilon = Math::epsilon<T>()) const;
...
template<class T, class DATA> inline
bool Vec4_Basic_Glm<T, DATA>::equals	(const Vec4& rhs, T epsilon) const
{
...
template<class T, class DATA> inline
bool Vec4_Basic_Glm<T, DATA>::equals0	(const Vec4& rhs, T epsilon) const
{
...
template<class T, class DATA> inline
T	Vec4_Basic_Glm<T, DATA>::operator[](SizeType i) const
{
...
template<class T, class DATA> inline
T&	Vec4_Basic_Glm<T, DATA>::operator[](SizeType i)
{
	NMSP_ASSERT(i >= 0 && i < s_kElementCount, "Vec4_Basic_Glm<T, DATA>::operator[]");
	return *(sCast<T*>(this) + i);
}
