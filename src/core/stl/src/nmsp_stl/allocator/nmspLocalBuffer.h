...
public:
	NMSP_NODISCARD void* alloc(SizeType n) NMSP_NOEXCEPT
	{
...
template<size_t LOCAL_SIZE, size_t ALIGN = s_kDefaultAlign, bool ENABLE_FALLBACK_ALLOC = true, class FALLBACK_ALLOCATOR = DefaultAllocator_T<ALIGN>>
class LocalBuffer_T
{
public:
